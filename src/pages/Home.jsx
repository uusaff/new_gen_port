    ...
    <section className="relative pt-12 pb-24 px-8 overflow-hidden flex flex-col items-center min-h-[90vh]">
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end h-full flex-grow mt-[20vh] md:mt-[25vh]">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="text-[#D90429] text-xs font-bold tracking-widest uppercase mb-6 transition-colors duration-700">
          ...
          <motion.div variants={fadeUp} className="flex gap-6 mt-10">
            <a href="https://github.com/uusaff" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-[#D90429] transition-colors duration-300">
            ...
            <a href="https://linkedin.com/in/uusaff" target="_blank" rel="noreferrer" className="text-gray-500 hover:text-[#D90429] transition-colors duration-300">
          ...
          {/* Badges moved to left column to balance layout */}
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4 mt-10">
            <div className="border border-black/10 dark:border-white/10 p-4 w-full sm:w-48 rounded-xl bg-[#F4F4F0]/80 dark:bg-[#0A0A0A]/80 backdrop-blur-md shadow-sm transition-colors duration-700 flex flex-col justify-center">
        ...
        <motion.div 
          ...
          className="w-full md:w-1/3 flex flex-row md:flex-col justify-end items-end text-left md:text-right mt-12 md:mt-0 z-20"
        >
